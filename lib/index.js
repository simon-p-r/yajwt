...
exports.sign = (options, cb) => {
    ...
    results.token = JWT.sign(validOptions.value);
    return results;
...
exports.verify = (options, cb) => {
    ...
    if (typeof cb === 'function') {
        ...
        Joi.validate(options, schema, (err, result) => {
            ...
            if (decoded === null) {
                return cb(new Error('JWT cannot be decoded'), null);
            }
            ...
            verify.on('done', (valid, data) => {
                ...
                return cb(new Error('Token is not valid due to issues with signature'), null);
            });
